...
var makeTitle = function(score) {
	if (score < 1000) {
		return "哟吼，这破游戏还挺难的，我才" + score + "分，你能得多少分呢？";
	} else {
		return "就这？我是天才，得了" + score + "分，你能得多少分呢？";
	}
}
...
game.States.preload = function() {
	this.preload = function() {
		var preloadSprite = game.add.sprite(0.0000001, game.height / 2, 'loading');
...
game.States.start = function() {
	...
	this.update = function() {
		if (this.myStartFire) {
			...
			// 碰撞检测
			game.physics.arcade.overlap(this.mybullets, this.enemy1.enemys, this.enemy1.hitEnemy, null, this
				.enemy1);
			game.physics.arcade.overlap(this.mybullets, this.enemy2.enemys, this.enemy2.hitEnemy, null, this
				.enemy2);
			game.physics.arcade.overlap(this.mybullets, this.enemy3.enemys, this.enemy3.hitEnemy, null, this
				.enemy3);
